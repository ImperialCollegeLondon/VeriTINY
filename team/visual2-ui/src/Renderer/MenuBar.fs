...
let helpMenu() =
        makeMenu "Help" (
            [
                makeItem "Help Docs Here" Core.Option.None (runExtPage <| visualDocsPage "")
                menuSeparator
                makeItem "About" Core.option.None (fun () ->
                    showVexAlert (sprintf "<h4>  About Name Here v%s</h4> " Refs.appVersion +
                                "(c) 2018, Imperial College <br>" +
                                " Using a UI based on VisUAL2: Salman Arif (VisUAL), HLP 2018 class" +
