...
let addFixedToolTips() =
    ...
    makeButtonTT "bottom" "tab-mem" [ "tootip-fixed" ] "Allows simulation of circuit"
    makeButtonTT "bottom" "tab-reg" [ "tooltip-fixed" ] "Allows connections to be made between VeriTINY modules"
