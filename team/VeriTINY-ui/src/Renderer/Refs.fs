...
let blockDropDown = getHtml "blockDropDown"
let DFFSizeInput = getHtml "DFFSize"
let addBlockButton = getHtml "addBlockBtn"
let clearBlocksButton = getHtml "clearBlocksBtn"
